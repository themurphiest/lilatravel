// ═══════════════════════════════════════════════════════════════════════════════
// PAGE: JOSHUA TREE GUIDE (coming soon placeholder)
// ═══════════════════════════════════════════════════════════════════════════════
//
  ...
  return (
    <>
      ...
      <section style={{
        ...
        background: `url(${P.joshuaTree}) center/cover no-repeat`,
      }}>
        <div style={{
          ...
          <div style={{ maxWidth: 920, margin: "0 auto", width: "100%" }}>
            <FadeIn from="bottom" delay={0.1}>
              ...
              <p style={{
                ...
                Desert clarity so sharp it rearranges something inside you.
              </p>
            </FadeIn>
          </div>
        </div>
        ...
        <FadeIn>
          <div style={{ maxWidth: 520, margin: "0 auto" }}>
            <span style={{
              ...
              color: C.goldenAmber, display: "block", marginBottom: 16,
            }}>Coming Soon</span>
            <h2 style={{
              fontFamily: "'Cormorant Garamond', serif",
            ...
            <p style={{
              ...
              We're mapping the best stargazing spots, tracking desert blooms, and finding the stillness between the boulders. Check back soon — or start planning now.
            </p>
            <Link to="/plan" style={{
